...
def parse_opt(known=False):
    ...
    #=========================================================================
    # use the values we'll be entering for img, batch, epochs, data, and weights with values from dvc tracked params.yaml file ####
    ...
    # opt.resume = params['resume']
    # opt.evolve = params['evolve']
    # opt.freeze = params['freeze']
